package com.adrianbadarau.bank.transactions.config
...
class CacheConfiguration(
    ...
    fun hazelcastInstance(jHipsterProperties: JHipsterProperties): HazelcastInstance {
        ...
        val hazelCastInstance = Hazelcast.getHazelcastInstanceByName("transactions")
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized")
            return hazelCastInstance
        }
        val config = Config()
        config.instanceName = "transactions"
        ...
        config.mapConfigs["com.adrianbadarau.bank.transactions.domain.*"] = initializeDomainMapConfig(jHipsterProperties)
