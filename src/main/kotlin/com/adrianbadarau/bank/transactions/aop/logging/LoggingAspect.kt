package com.adrianbadarau.bank.transactions.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(com.adrianbadarau.bank.transactions.repository..*)" +
            " || within(com.adrianbadarau.bank.transactions.service..*)" +
            " || within(com.adrianbadarau.bank.transactions.web.rest..*)"
    )
